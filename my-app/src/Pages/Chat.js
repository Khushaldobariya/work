                        ...
                        <div class="tab-content py-4">
                            <div class="tab-pane show active" id="chat">
                                <div>
                                    ...
                                    <ul class="list-unstyled chat-list" data-simplebar style={{maxHeight: "410px"}}>
                                        <li class="active">
                                            <a href="javascript: void(0);">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-shrink-0 align-self-center me-3">
                                                        <img src={avatar2} class="rounded-circle avatar-xs" alt=""/>
                                                    </div>
                                        ...
                                        <li>
                                            <a href="javascript: void(0);">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-shrink-0 align-self-center me-3">
                                                        <img src={avatar3} class="rounded-circle avatar-xs" alt=""/>
                                                    </div>
                                        ...
                                        <li>
                                            <a href="javascript: void(0);">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-shrink-0 align-self-center me-3">
                                                        <img src={avatar4} class="rounded-circle avatar-xs" alt=""/>
                                                    </div>
                                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <li>
                                            <a href="javascript: void(0);">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-shrink-0 align-self-center me-3">
                                                        <img src={avatar6} class="rounded-circle avatar-xs" alt=""/>
                                                    </div>
                                                    <div class="flex-grow-1 overflow-hidden">
                ...
                <div class="card">
                    ...
                    <div>
                        <div class="chat-conversation p-3">
                            <ul class="list-unstyled mb-0" data-simplebar style={{maxHeight: "486px"}}>
                                <li> 
